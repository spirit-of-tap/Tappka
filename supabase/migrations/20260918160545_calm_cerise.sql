...
-- Admin comments are not coach feedback: coach_stats in coach_review_filtered_ids
-- must only count role = ''coach''. Admins are developers/students with elevated
-- permissions (is_coach_or_admin() checks stay), not coaches. See GH #153.
