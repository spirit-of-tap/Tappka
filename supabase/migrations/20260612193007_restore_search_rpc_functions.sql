-- Restores the two search-page RPC functions that were created out-of-band
-- (no committed migration; lost on rebuild from migration history — same
-- incident as 20260612192528). Definitions verbatim from db/sql/functions.sql.
