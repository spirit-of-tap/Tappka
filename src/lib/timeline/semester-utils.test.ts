...
describe("getSemesterInfo", () => {
  ...
  it("handles Winter semester dates correctly", () => {
    // October 2025 (m = 10)
    ...
    expect(oct).toEqual({
      ...
      studyYear: 1,
      label: "1. ročník — Zimní semestr (2025/2026)",
    })
  ...
  it("handles Summer semester dates correctly", () => {
    ...
    expect(mar).toEqual({
      ...
      academicYearLabel: "2025/2026",
      studyYear: 1,
      label: "1. ročník — Letní semestr (2025/2026)",
    })
  ...
  it("advances study year for 2nd and 3rd year", () => {
    ...
    expect(year2?.label).toBe("2. ročník — Zimní semestr (2026/2027)")

    const year3 = getSemesterInfo("2028-03-01", 2025)
    expect(year3?.studyYear).toBe(3)
    expect(year3?.label).toBe("3. ročník — Letní semestr (2027/2028)")
  })
})
