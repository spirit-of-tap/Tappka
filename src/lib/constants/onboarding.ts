...
export const ONBOARDING_TEXT = {
  ...
  pendingStep: {
    ...
    mainText: "Tvůj účet nyní čeká na schválení.",
    processTitle: "Co se děje teď:",
    processList: [
      "Dostaneme oznámení o tvé registraci",
      "Vytvoříme tvůj profil v systému",
      "Po dokončení obdržíš email",
      "Budeš mít plný přístup do Tappky",
    ],
    timeEstimate: "Obvyklá doba schválení: do 24 hodin",
    emailLabel: "Tvůj email:",
