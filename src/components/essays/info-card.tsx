    ...
    <div className="flex gap-2 rounded-lg border border-border/50 bg-muted/30 p-3 text-xs leading-relaxed text-muted-foreground">
      ...
      <div className="space-y-1">
        <p>
          ...
          jak jste získané znalosti dokázali nebo dokážete převést do praxe. Nejdůležitější je kvalita
          reflexe na získané myšlenky, nástroje a poznatky; nejde o přepisování obsahu.
        </p>
        <p>
          Eseji, které ATP chybí, má kouč právo vrátit k přepracování či ji následně bodově neuznat.
        </p>
        <p>
          V rámci studia má každý teampreneur přečíst knihy za <strong>120 bodů</strong>. Za jednu
